...
> **一句话创建 Agent。**
>
> 一个用于定义 AI Agent 配置的开源规范。用一句话描述你的需求，让 LLM 自动生成完整、结构化的 AgentProfile。
...
| `tools` | `string[]` | 否 | Agent 可使用的工具标识符列表 |
| `skills` | `string[]` | 否 | 从技能库加载的技能模块 |
